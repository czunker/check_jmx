...
public class JMXQuery {
	...
	private static final String CRITICAL_STRING = "CRITICAL -"; 
	...
	public static void main(String[] args) {
			...
			try{
				...
				query.reportPerfData(System.out);
				System.out.println();
				System.exit(status);
			}catch(Exception ex){
				ex.printStackTrace();
	...
	private void reportPerfData(PrintStream out) {
        out.print((new StringBuilder("|")).append(info_attribute)
        								   .append("=")
        								   .append(checkData)
        								   .append(";")
        								   .append(warning)
